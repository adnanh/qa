            ...
            if(globalContentEditableBlur && curelement !== null){
                ...
                if(!isEditable){
                    ...
                    if (curelement.select) {
                        ...
                        curelement.selectionStart = curelement.selectionEnd;
...
// return the index of the stylesheet rule
        ...
        removeCSSRule = function(index){
            ...
            // BUGFIX BY HIDEX START
            if (sheet.rules && (index > sheet.rules.length -1))
                return;
            if (sheet.cssRules && (index > sheet.cssRules.length -1))
                return;
            // BUGFIX BY HIDEX END
