 ...
 * @param {string=} [placeholder=Add a new keyword, 2 minimum, 10 maximum] Placeholder text for the control.
    ...
    return {
        ...
        controller: ["$scope","$attrs","$element", function($scope, $attrs, $element) {
            tagsInputConfig.load('tagsInput', $scope, $attrs, {
                placeholder: [String, 'Add a new keyword, 2 minimum, 10 maximum'],
                tabindex: [Number],
